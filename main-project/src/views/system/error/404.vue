        ...
        <div class="col-6 align-self-center">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" style="visibility: visible;">
            <g>
              ...
              <g id="planet" transform="matrix(0.9994,-0.0339,0.0339,0.9994,-3.6968,33.6727)" style="transform-origin: 0px 0px;">
                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

                <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" transform="matrix(1,0,0,1,2.921,0)" style="transform-origin: 0px 0px;"></circle>

                <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" transform="matrix(1,0,0,1,-2.921,0)" style="transform-origin: 0px 0px;"></circle>
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
              ...
              <g id="stars">
                <g id="starsBig">
                  <g transform="matrix(0.9986,0.0522,-0.0522,0.9986,-1.3559,8.2799)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.9953,0.0957,-0.0957,0.9953,33.5487,-19.4026)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.9999,-0.014,0.014,0.9999,-7.886,19.2524)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.945,-0.327,0.327,0.945,-182.3077,106.5961)" style="transform-origin: 0px 0px;">
                ...
                <g id="starsSmall">
                  <g transform="matrix(0.908,0,0,0.9088,39.7599,35.2192)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.747,0,0,0.748,123.8573,76.594)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.507,0,0,0.5072,114.114,145.4691)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0.186,0,0,0.1864,198.6416,448.8782)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0,0,0,0,186.7234,411.8791)" style="transform-origin: 0px 0px;">
                  ...
                  <g transform="matrix(0,0,0,0,508.4028,434.9948)" style="transform-origin: 0px 0px;">
                ...
                <g id="circlesBig">
                  ...
                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>

                  <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-1.947)" style="transform-origin: 0px 0px;"></circle>
                </g>
                <g id="circlesSmall">
                  <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                  <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" transform="matrix(1,0,0,1,0,-3.895)" style="transform-origin: 0px 0px;"></circle>
                </g>
              </g>
              <g id="spaceman" clip-path="url(cordClip)" transform="matrix(0.9999,0.017,-0.017,0.9999,7.459,2.0532)" style="transform-origin: 0px 0px;">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" transform="matrix(0.9999,0.017,-0.017,0.9999,8.8951,-8.504)" style="transform-origin: 0px 0px;"></path>
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                  <g clip-path="url(#GlassClip)">
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" transform="matrix(0.866,-0.5,0.5,0.866,-10.3249,370.0963)" style="transform-origin: 0px 0px;"></polygon>
                  </g>
                </g>
              </g>
            </g>
